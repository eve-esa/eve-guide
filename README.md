...
The official documentation for the EVE project. It is part of the Earth Virtual Expert (EVE) initiative—an open-science program funded by the European Space Agency’s Φ-lab and developed by Pi School, in collaboration with Imperative Space and Mistral AI.

**Read the docs** - https://eve-esa.github.io/eve-guide/
